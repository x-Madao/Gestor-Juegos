...
public class JuegoDTO {
    ...
    public JuegoDTO(Integer id,String suNombre,EstadoJuego estadoActual,GeneroJuego genero,Integer duracion){
        this.id = id;
    ...
    public Juego toEntity(){
        return new Juego(
            this.nombre,this.estado,this.genero,this.duracion
        );
    }
